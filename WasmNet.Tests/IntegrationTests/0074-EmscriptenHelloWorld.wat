...
(module
  ...
  (func (;25;) (type 5) (param i32 i32) (result i32)
    ...
    local.get 2
    select)
  (func (;26;) (type 12) (param f64 i32) (result f64)
    (local i64 i32)
    block  ;; label = @1
      local.get 0
      i64.reinterpret_f64
  ...
  (func (;27;) (type 1) (param i32 i32 i32) (result i32)
    ...
    local.get 4)
  (func (;28;) (type 13) (param i32 i32 i32 i32 i32) (result i32)
  ...
  (export "stackRestore" (func 56))
  (export "stackAlloc" (func 57))
  (export "emscripten_stack_get_current" (func 58))
  (elem (;0;) (i32.const 1) func 2 11 10 12 38 39)
