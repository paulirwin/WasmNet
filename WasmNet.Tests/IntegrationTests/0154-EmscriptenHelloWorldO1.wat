...
;; NOTE: this is an optimized version of the 0074 test.
;; NOTE: compile to wasm with `emcc -O1 0074-EmscriptenHelloWorld.c -o 0154-EmscriptenHelloWorldO1.wasm`
;; NOTE: then convert to wat with `wasm2wat`
(module
